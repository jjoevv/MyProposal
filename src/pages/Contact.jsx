...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Gửi dữ liệu formData đến địa chỉ email của bạn
    // Viết logic ở đây để xử lý việc gửi email
    console.log('Form submitted:', formData);
  };
  return (
    <Container
    fluid
    className="bg-gradient-blue mt-5 pt-3 px-5"
    ...
    >
      ...
      <Row className="justify-content-center mt-5 mb-4">
        ...
        <Col xs={12} md={4} className="primary-normal p-4 position-relative overflow-hidden">
